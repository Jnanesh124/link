...
SHORTLINK_API = environ.get('SHORTLINK_API', '8df0575886518521297d9cc0a9eb0db8aa675d92')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "06")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 't.me/Rockers_Movie_Requist_Group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ROCKERSBACKUP')
TUTORIAL = environ.get('TUTORIAL', 't.me/How_to_open_link_rockersbot')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Join @ROCKERSBACKUP')
